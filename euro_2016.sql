...
--
-- Host: 127.0.0.1
-- Generation Time: May 25, 2016 at 07:51 PM
...
(403, 4, 'Yvon Mvogo ', 'Young Boys', 'GK'),
(404, 4, 'Yann Sommer ', 'Borussia Monchenglad', 'GK'),
(405, 4, 'Johan Djourou ', 'Hamburg', 'CB'),
(406, 4, 'Nico Elvedi ', 'Borussia Monchenglad', 'CB'),
(407, 4, 'Michael Lang ', 'Basel', 'RB'),
(408, 4, 'Stephan Lichtsteiner ', 'Juventus', 'RB'),
(409, 4, 'Francois Moubandje ', 'Toulouse', 'CB'),
(410, 4, 'Ricardo Rodriguez ', 'Wolfsburg', 'LB'),
(411, 4, 'Fabian Schar ', 'Hoffenheim', 'CB'),
(412, 4, 'Philippe Senderos ', 'Grasshoppers', 'CB'),
(413, 4, 'Steve Von Bergen ', 'Young Boys', 'CB'),
(414, 4, 'Silvan Widmer ', 'Udinese', 'RM'),
(415, 4, 'Valon Behrami ', 'Watford', 'CDM'),
(416, 4, 'Blerim Dzemaili ', 'Genoa', 'CM'),
(417, 4, 'Gelson Fernandes ', 'Rennes', 'CDM'),
(418, 4, 'Fabian Frei ', 'Mainz', 'CM'),
(419, 4, 'Renato Steffen ', 'Basel', 'LM'),
(420, 4, 'Granit Xhaka ', 'Borussia Monchenglad', 'CM'),
(421, 4, 'Denis Zakaria ', 'Young Boys', 'CDM'),
(422, 4, 'Luca Zuffi ', 'Basel', 'CDM'),
(423, 4, 'Eren Derdiyok ', 'Kasimpasa', 'ST'),
(424, 4, 'Breel Embolo ', 'Basel', 'ST'),
(425, 4, 'Admir Mehmedi ', 'Bayer Leverkusen', 'ST'),
(426, 4, 'Haris Seferovic ', 'Eintracht Frankfurt', 'ST'),
(427, 4, 'Xherdan Shaqiri ', 'Stoke City', 'RM'),
(428, 4, 'Shani Tarashaj ', 'Grasshoppers', 'CAM'),
...
(1107, 11, 'Yevgen Khacheridi ', 'Dynamo Kiev', 'CB'),
(1108, 11, 'Artem Fedetskyi ', 'Dnipro Dnipropetrovs', 'RB'),
(1109, 11, 'Mykyta Kamenyuka ', 'Zorya Lugansk', 'LB'),
(1110, 11, 'Bogdan Butko ', 'Amkar Perm', 'RB'),
(1111, 11, 'Anatoliy Tymoshchuk ', 'Kairat', 'CDM'),
(1112, 11, 'Taras Stepanenko', 'Shakhtar Donetsk', 'CDM'),
(1113, 11, 'Viktor Kovalenko', 'Shakhtar Donetsk', 'CAM'),
(1114, 11, 'Maksym Malyshev ', 'Shakhtar Donetsk', 'CDM'),
(1115, 11, 'Ruslan Rotan', 'Dnipro Dnipropetrovs', 'CM'),
(1116, 11, 'Yevgen Shakhov ', 'Dnipro Dnipropetrovs', 'CM'),
(1117, 11, 'Yevgen Konoplyanka ', 'Sevilla', 'LW'),
(1118, 11, 'Oleg Gusyev', 'Dynamo Kiev', 'RW'),
(1119, 11, 'Sergiy Rybalka', 'Dynamo Kiev', 'CM'),
(1120, 11, 'Denys Garmash', 'Dynamo Kiev', 'CM'),
(1121, 11, 'Sergiy Sydorchuk', 'Dynamo Kiev', 'CM'),
(1122, 11, 'Andriy Yarmolenko ', 'Dynamo Kiev', 'RW'),
(1123, 11, 'Oleksandr Karavayev', 'Zorya Lugansk', 'RM'),
(1124, 11, 'Ivan Petryak ', 'Zorya Lugansk', 'LM'),
(1125, 11, 'Oleksandr Zinchenko ', 'Ufa', 'CAM'),
(1126, 11, 'Roman Zozulya ', 'Dnipro Dnipropetrovs', 'ST'),
(1127, 11, 'Artem Kravets ', 'Stuttgart', 'ST'),
(1128, 11, 'Pylyp Budkivskyi ', 'Zorya Lugansk', 'ST'),
...
(1501, 15, 'Ali Sasal Vural ', 'Eskisehirspor', 'GK'),
(1502, 15, 'Harun Tekin ', 'Bursaspor', 'GK'),
(1503, 15, 'Onur Kivrak ', 'Trabzonspor', 'GK'),
(1504, 15, 'Volkan Babacan ', 'Istanbul Basaksehir', 'GK'),
(1505, 15, 'Gokhan Gonul ', 'Fenerbahce', 'RB'),
(1506, 15, 'Sener Ozbayrakli', 'Fenerbahce', 'RB'),
(1507, 15, 'Ahmet Calik ', 'Genclerbirligi', 'CB'),
(1508, 15, 'Caglar Soyuncu ', 'Alt?nordu', 'CB'),
(1509, 15, 'Hakan Balta ', 'Galatasaray', 'CB'),
(1510, 15, 'Mehmet Topal ', 'Fenerbahue', 'CDM'),
(1511, 15, 'Semih Kaya ', 'Galatasaray', 'CB'),
(1512, 15, 'Serdar Aziz ', 'Bursaspor', 'CB'),
(1513, 15, 'Caner Erkin ', 'Fenerbahce', 'LB'),
(1514, 15, 'Ismail Koybasi', 'Besiktas', 'LB'),
(1515, 15, 'Emre Mor ', 'Nordsjaelland', 'ST'),
(1516, 15, 'Gokhan Tore ', 'Besiktas', 'RW'),
(1517, 15, 'Volkan Sen ', 'Fenerbahce', 'RM'),
(1518, 15, 'Yasin Oztekin ', 'Galatasaray', 'LW'),
(1519, 15, 'Hakan Calhanogu ', 'Bayer Leverkusen', 'CAM'),
(1520, 15, 'Mahmut Tekdemir ', 'Istanbul Basaksehir', 'CDM'),
(1521, 15, 'Nuri Sahin ', 'Borussia Dortmund', 'CM'),
(1522, 15, 'Oguzhan Ozyakup ', 'Besiktas', 'CM'),
(1523, 15, 'Ozan Tufan ', 'Fenerbahce', 'CDM'),
(1524, 15, 'Selcuk Inan ', 'Galatasaray', 'CM'),
(1525, 15, 'Alper Potuk ', 'Fenerbahce', 'LW'),
(1526, 15, 'Arda Turan ', 'Barcelona', 'RM'),
(1527, 15, 'Olcay Sahan ', 'Besiktas', 'CAM'),
(1528, 15, 'Burak Yilmaz ', 'Beijing Guoan', 'ST'),
(1529, 15, 'Cenk Tosun ', 'Besiktas', 'ST'),
(1530, 15, 'Mevlut Erdinc ', 'Guingamp', 'ST'),
(1531, 15, 'Yunus Malli', 'Mainz', 'CAM'),
